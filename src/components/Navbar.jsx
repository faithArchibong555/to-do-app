        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              {/* Settings Button */}
              <button
                onClick={() => alert("Settings panel coming soon! 🚀\n\nYou'll be able to customize themes, notifications, and more.")}
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                aria-label="Settings"
              ...
              {/* Profile Button */}
              <button
                 onClick={() => alert("Profile features coming soon! 👤\n\nYou'll be able to view your productivity stats and achievements.")}
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            ...
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="flex justify-center gap-6 pt-2">
                ...
                >
                  ...
                  <span className="text-xs mt-1 text-gray-400 dark:text-gray-500">Settings</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs mt-1 text-gray-400 dark:text-gray-500">Profile</span>
                </button>
              </div>
            </div>
          </div>
